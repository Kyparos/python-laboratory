...
ch.greet(4,
         '7) Ввести дійсні числа х1, у1, х2, у2, ..., х10, у10. Знайти периметр десятикутника, вершини якого мають '
         'відповідно координати (х1, у1), (х2, у2), ..., (х10, у10). Написати функцію обчислення відстані між двома '
         'точками, заданими своїми координатами, які передаються при виклику функції.')
while True:
